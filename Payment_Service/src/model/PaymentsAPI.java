...
public class PaymentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String output = payObj.insertPayment(request.getParameter("firstname"), request.getParameter("lastname"),
				request.getParameter("ammount"), request.getParameter("cardnumber"), request.getParameter("date"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
...

		{
			...
			String output = payObj.updatePayment(paras.get("hidItemIDSave").toString(),
					...
					paras.get("ammount").toString(), paras.get("cardnumber").toString(), paras.get("date").toString(),
