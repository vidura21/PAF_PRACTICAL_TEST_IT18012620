...
public class Payment {
	...
	public String insertPayment(String firstname, String lastname, String ammount, String cardnumber, 
			String cvv) {
		...
		try {
			...
			String query = " insert into payments (`paymentID`,`firstname`,`lastname`,`ammount`,`cardnumber`,`cvv`)"
					+ " values (?, ?, ?, ?, ?, ?)";
	...
	public String updatePayment(String paymentid, String firstname, String lastname, String ammount, String cardnumber,
		...
		try {
			...
			// create a prepared statement
			String query = "UPDATE payments SET firstname=?,lastname=?,ammount=?,cardnumber=?,date=current_timestamp,cvv=? WHERE paymentID=?";
			PreparedStatement preparedStmt = con.prepareStatement(query);
			// binding values
